...
namespace E_Commerce.Infrustructure.Migrations
{
    ...
    [Migration("20260614153200_AddCheckoutShippingDetails")]
    partial class AddCheckoutShippingDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce.Data.Entity.Message", b =>
                {
                    ...
                    b.HasIndex("ConversationId", "SenderId", "CreatedAt");
            ...
            modelBuilder.Entity("E_Commerce.Data.Entity.Product", b =>
                {
                    ...
                    b.Property<int?>("LeadTimeDaysSample")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("SampleAvailable")
                        .HasColumnType("bit");

                    b.Property<int?>("SampleMoq")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SupplyAbility")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("E_Commerce.Data.Entity.ProductCertificate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("E_Commerce.Data.Entity.ProductSpecification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("E_Commerce.Data.Entity.ProductTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("E_Commerce.Data.Entity.ProductVideo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("E_Commerce.Data.Entity.ReviewHelpfulVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("E_Commerce.Data.Entity.ShippingRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Country", "Zone", "Method", "IsActive")
                        .IsUnique();
            ...
            modelBuilder.Entity("E_Commerce.Data.Identity.User", b =>
                {
                    ...
                    b.Property<DateTime?>("MagicLinkExpiry")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("E_Commerce.Data.Entity.Order", b =>
                {
                    ...
                    b.OwnsOne("E_Commerce.Data.ValueObjects.ShippingAddress", "ShippingAddress", b1 =>
                        {
                            ...
                            b1.ToTable("OrderShippingAddresses", (string)null);
            ...
            modelBuilder.Entity("E_Commerce.Data.Entity.ReviewHelpfulVote", b =>
                {
                    ...
                    b.HasOne("E_Commerce.Data.Identity.User", "Reviewer")
                        .WithMany()
