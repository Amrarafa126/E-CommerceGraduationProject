...
namespace E_Commerce.Infrustructure.ImpelmationUnitOfWork
{
    ...
    public class UnitOfWork(AppDBContext context) : IUnitOfWork
    {
        ...
        private IProductOptionsRepos? productOptions;
        private IProductOptionValuesRepos? productOptionValues;
        private IProductImageRepos? _productImage;
        private IProductPriceTierRepos? _productPrice;
        private IProductVariantsRepos? _productVariantsRepos;
        private IProductVariantValueRepos? _productVariantValueRepos;
        ...
        public IProductOptionValuesRepos ProductOptionValues => productOptionValues ??= new ProductOptionValuesRepos(context);
        public IProductImageRepos productImage => _productImage ??= new ProductImageRepos(context);
        public IProductPriceTierRepos productPrice => _productPrice ??= new ProductPriceTierRepos(context);
        public IProductVariantsRepos productVariantsRepos => _productVariantsRepos ??= new ProductVariantsRepos(context);
        public IProductVariantValueRepos productVariantValueRepos => _productVariantValueRepos ??= new ProductVariantValueRepos(context);
        public IRefreshTokenRepository refreshTokenRepository => _refreshTokenRepository ??= new RefreshTokenRepository(context);
