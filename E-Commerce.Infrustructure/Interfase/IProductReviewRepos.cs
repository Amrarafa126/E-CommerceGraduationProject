...
namespace E_Commerce.Infrustructure.Interfase
{
    public interface IProductReviewRepos : IGenericRepositoryAsync<ProductReview>
    {
        ...
        Task<(IEnumerable<Data.Entity.ProductReview> Items, int Total)> GetByBuyerAsync(
            Guid buyerId, int page, int pageSize, CancellationToken ct = default);
        Task<(IEnumerable<Data.Entity.ProductReview> Items, int Total)> GetByCompanyAsync(
