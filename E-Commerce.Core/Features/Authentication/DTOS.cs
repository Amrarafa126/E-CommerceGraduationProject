...
{
    public record UserDto(Guid Id, string Email, string FirstName, string LastName, string FullName, string? PhoneNumber, string Role, Guid? OwnedCompanyId, Guid? EmployerCompanyId, bool IsEmailVerified, bool IsActive, DateTime CreatedAt);
